...
\begin{biography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/Wu.eps}}]{Yongwei Wu}
...
\begin{biography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/Ren.eps}}]{Jinglei Ren}
...
\begin{biography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/Zhao.eps}}]{Xun Zhao}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/Zheng.eps}}]{Weimin Zheng}
